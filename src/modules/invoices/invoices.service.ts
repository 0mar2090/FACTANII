...
export class InvoicesService {
  ...
  async getPdf(
    ...
    const pdfData: PdfInvoiceData = {
      ...
      opGratuitas: Number(invoice.opGratuitas),
      opExportacion: Number(invoice.opExportacion),
      opIvap: Number(invoice.opIvap),
      igvIvap: Number(invoice.igvIvap),
      igvRate: invoice.items.some((i) => i.tipoAfectacion === '17') ? 0.04 : 0.18,
